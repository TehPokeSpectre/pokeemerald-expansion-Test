...
// TMs/HMs. They don't have a set flingPower, as that's handled by GetFlingPowerFromItemId.
    ...
    [ITEM_TM67] =
    {
        ...
        .description = COMPOUND_STRING(
            "Attacks the foe\n"
            "by firing 2 to 5\n" 
            "icicles in a row."), // Todo
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
        .secondaryId = MOVE_ICICLE_SPEAR, // Todo
    },
    ...
    [ITEM_TM83] =
    {
        ...
        .description = COMPOUND_STRING(
            "Ice-covered feet\n"
            "hit a foe and destroy\n"
            "the terrain."), // Todo
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
        .secondaryId = MOVE_ICE_SPINNER, // Todo
    },
    ...
    [ITEM_TM88] =
    {
        ...
        .description = COMPOUND_STRING(
            "If stats lowered\n"
            "during this turn\n"
            "power is doubled."), // Todo
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
        .secondaryId = MOVE_LASH_OUT, // Todo
    },
    ...
    [ITEM_TM89] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "wings and hits twice in a row."), // Todo
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
    ...
    [ITEM_TM91] =
    {
        ...
        .description = COMPOUND_STRING(
            "Does more damage\n"
            "if the user outweighs\n"
            "the foe."), // Todo
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
        .secondaryId = MOVE_HEAVY_SLAM, // Todo
    },
